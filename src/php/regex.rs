...
pub fn preg_match(pattern: &str, subject: &str, matches: Option<&mut Vec<String>>) -> Result<i64, String> {
...
pub fn preg_split(pattern: &str, subject: &str, limit: Option<usize>) -> Result<Vec<String>, String> {
    let re = compile_pattern(pattern)?;
